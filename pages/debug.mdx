...
If you are having issues with AnythingLLM, the first thing you should do is check the logs. You can find the logs in the `logs` folder of your AnythingLLM storage - which you can find [on your computer using this guide.](../installation/general.mdx#where-is-my-data-located)
