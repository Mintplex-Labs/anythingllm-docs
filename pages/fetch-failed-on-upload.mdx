...
See [CPU instruction set requirements](/installation-docker/system-requirements#cpu-instruction-set-requirements) for how to check whether your CPU exposes AVX2, including on virtual machines where the hypervisor may be hiding it.
