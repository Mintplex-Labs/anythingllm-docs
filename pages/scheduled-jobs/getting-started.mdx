...
Click the **gear icon** to open Settings, then select **Scheduled Jobs** from the sidebar. You'll see a list of your existing jobs (empty the first time) along with a **New Job** button.
