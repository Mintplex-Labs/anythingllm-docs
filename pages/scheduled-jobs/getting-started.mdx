...
From the main Scheduled Jobs page, each job row gives you:

- **The job's name, schedule, last run, and next run** at a glance
- **An enable/disable toggle** — flip it off to pause the job without deleting it
- **Run Now** — trigger an immediate run, bypassing the schedule
- **Edit** — change the name, prompt, schedule, or tools
- **View Runs** — open the run history for this job
