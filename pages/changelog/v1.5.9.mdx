...
<div class="nested">
  ...
  features! > Now you can upload local files, edit their contents, and
  AnythingLLM will automatically re-sync these files. > While in beta, please do
  not watch thousands of files locally. <br />> [Read more about local file sync
