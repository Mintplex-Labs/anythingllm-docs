...
**Example:** `@agent read the email thread with ID 18abc123def`

#### Gmail Read Message

Read a single email message by its ID. Returns message details including sender, recipients, subject, body, date, and attachment information.

**Example:** `@agent read the email message with ID 18abc123def456`
