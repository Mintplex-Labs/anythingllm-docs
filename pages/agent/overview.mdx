...
import { CardsIcon, RowsIcon, GlobeIcon, DiagramIcon, NewsletterIcon, FileIcon, BoxIcon, Database } from '/components/icons'
...
<Cards>
  ...
  <Card icon={<Database />} title="SQL Agent" href="#what-is-sql-agent-and-how-to-use-it" />
</Cards>
...
The built-in SQL agent is a skill that you can leverage to run real-time analytics and queries against a real database. The agent can do all of the following:
