...
- [SerpApi](https://serpapi.com/) - Scrapes the major search engines including Google, Amazon, Google Maps, Google News, Google Shopping, Baidu, and more.
...
To use Google Search, create a Programmable Search Engine and generate an API key via the [Google Programmable Search Engine control panel](https://programmablesearchengine.google.com/controlpanel/create). For rate limit information, see the [Google Custom Search API documentation](https://developers.google.com/custom-search/v1/overview).
