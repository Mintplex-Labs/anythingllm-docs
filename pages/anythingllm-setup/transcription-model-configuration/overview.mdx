...
image: "/images/anythingllm-setup/transcription-model-configuration/thumbnail.png"
---
...
<Image
  src="/images/anythingllm-setup/transcription-model-configuration/thumbnail.png" 
  height={1080} 
  width={1920} 
  quality={100}
...
<Cards>
  <Card title="Built-in (Xenova)" href="local/built-in"> 
    <Image
      src="/images/anythingllm-setup/transcription-model-configuration/local/built-in/thumbnail.png" 
      height={1080} 
      width={1920} 
      quality={100}
...
<Cards>
  <Card title="OpenAI" href="cloud/openai"> 
    <Image
      src="/images/anythingllm-setup/transcription-model-configuration/cloud/openai/thumbnail.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="OpenAI"
