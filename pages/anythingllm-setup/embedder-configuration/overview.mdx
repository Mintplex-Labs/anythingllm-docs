...
image: "/images/anythingllm-setup/embedder-configuration/thumbnail.png"
---
...
<Image
  src="/images/anythingllm-setup/embedder-configuration/thumbnail.png" 
  height={1080} 
  width={1920} 
  quality={100}
...
<Cards>
  <Card title="Built-in (default)" href="local/built-in"> 
    <Image
      src="/images/anythingllm-setup/embedder-configuration/local/built-in/thumbnail.png" 
      height={1080} 
      width={1920} 
      quality={100}
  ...
  <Card title="Ollama" href="local/ollama"> 
    <Image
      src="/images/anythingllm-setup/embedder-configuration/local/ollama/thumbnail.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="Ollama"
  ...
  <Card title="LM Studio" href="local/lmstudio"> 
    <Image
      src="/images/anythingllm-setup/embedder-configuration/local/lmstudio/thumbnail.png" 
      height={1080} 
      width={1920}
      quality={100} 
      alt="LM Studio"
  ...
  <Card title="Local AI" href="local/localai"> 
    <Image
      src="/images/anythingllm-setup/embedder-configuration/local/localai/thumbnail.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="Local AI"
...
<Cards>
  <Card title="OpenAI" href="cloud/openai"> 
    <Image
      src="/images/anythingllm-setup/embedder-configuration/cloud/openai/thumbnail.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="OpenAI"
  ...
  <Card title="Azure OpenAI" href="cloud/azure-openai"> 
    <Image
      src="/images/anythingllm-setup/embedder-configuration/cloud/azure-openai/thumbnail.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="Azure OpenAI"
  ...
  <Card title="Cohere" href="cloud/cohere"> 
    <Image
      src="/images/anythingllm-setup/embedder-configuration/cloud/cohere/thumbnail.png" 
      height={1080} 
      width={1920} 
      quality={100}
      alt="Cohere"
