...
<Callout type="info" emoji="💡">
  **Easy Cloud Deployment**
    ...
    AnythingLLM offers easily integrated one-click docker deployment templates with [Railway](https://railway.app/template/HNSCS1?referralCode=WFgJkn), [Render](https://render.com/deploy?repo=https://github.com/Mintplex-Labs/anything-llm&branch=render), and [Easypanel](https://easypanel.io/templates/anythingllm).
