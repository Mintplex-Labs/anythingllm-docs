...
<Callout type="info" emoji="💡">
  Available blocks will vary depending on your AnythingLLM version. Check the [blocks documentation](/agent-flows/blocks/intro) to see which blocks are available in your deployment.
</Callout>
