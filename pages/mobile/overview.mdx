...
<Callout type="info" emoji="️💡">
  Requires _version 1.8.5_ or higher of AnythingLLM Desktop or AnythingLLM Cloud/Self-hosted instances. In 1.8.5, this feature is hidden behind the ["Experimental features"](/beta-preview/enable-feature) sidebar item.

**To enable experimental features**, you need to follow the instructions [here](/beta-preview/enable-feature).
</Callout>
