...
image: "/images/features/thumbnail.png"
---
...
<Cards>
  {/* The page we are linking here `pages/features/ai-agents.mdx` is incomplete, so we are hiding this card
  <Card title="AI Agents" href="ai-agents"> 
	<Image
	 src="/images/thumbnails/agents.png" 
	 height={1080} 
	 width={1920} 
	 quality={100}
