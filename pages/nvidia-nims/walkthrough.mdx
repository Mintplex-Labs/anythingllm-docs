...
<Callout type="warning" emoji="️💡">
 If you encounter any issues with the NIM installer - you will need to open a ticket with NVIDIA via their NIM [community fourm](https://forums.developer.nvidia.com/c/ai-data-science/nvidia-nim/678).
</Callout>
