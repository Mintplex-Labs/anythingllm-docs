...
Download the [bundle](https://cdn.useanything.com/support/ollama/win32_lib.zip) from the AnythingLLM S3 bucket.

_direct link:_ https://cdn.useanything.com/support/ollama/win32_lib.zip
