...
Download the [bundle](https://cdn.anythingllm.com/support/0.5.4/ollama/win32_lib.zip) from the AnythingLLM S3 bucket.

_direct link:_ https://cdn.anythingllm.com/support/0.5.4/ollama/win32_lib.zip
